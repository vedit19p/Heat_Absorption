    ...
    $("#btnSubmit").click(function(evt){
      ...
      evt.stopImmediatePropagation();
        ...
        if (drag1Good && drag2Good && drag3Good){
          ...
          if (wrongAnswer >= 3){
			activity.incorrectAnswer();
            $("#draggable1").css({ top: "168px",left: "657px"});
            $("#draggable2").css({ top: "168px", left:"418px"});
            $("#draggable3").css({ top: "168px", left: "198px"});
   ...
   $("#draggable1").draggable({ 
	...
	$("#droppable1").droppable({
		...
		drop: function(event, ui) {
			...
			// Snap element into proper position
			$(ui.draggable).css('top', '168px');
			$(ui.draggable).css('left', '657px');
			$(ui.draggable).css('z-index', '1');
		
			// Confirm drop position has been filled
			drag1Filled = true;
			...
			// Show submit button if all elements have been dropped
			decideToShowSubmit();
		}
	});
